...
Public API:
  - list_tiles_for_countries(countries: list[str], full_only: bool = False) -> list[tuple[int, int]]
  - list_tiles_for_continent(continent: str, full_only: bool = False) -> list[tuple[int, int]]
  - list_tiles_for_geometry(geom, full_only: bool = False) -> list[tuple[int, int]]
